...
const CYAN_CHROMA: f32 = 0.065;
const CYAN_HUE: f32 = 200.0;
pub(crate) const ZENBURN_CYAN_MINUS_4: Lazy<Oklch> = Lazy::new(|| oklch(0.45856485, CYAN_CHROMA, CYAN_HUE));
pub(crate) const ZENBURN_CYAN_MINUS_3: Lazy<Oklch> = Lazy::new(|| oklch(0.51914865, CYAN_CHROMA, CYAN_HUE));
pub(crate) const ZENBURN_CYAN_MINUS_2: Lazy<Oklch> = Lazy::new(|| oklch(0.595962, CYAN_CHROMA, CYAN_HUE));
pub(crate) const ZENBURN_CYAN_MINUS_1: Lazy<Oklch> = Lazy::new(|| oklch(0.6703748, CYAN_CHROMA, CYAN_HUE));
pub(crate) const ZENBURN_CYAN: Lazy<Oklch> = Lazy::new(|| oklch(0.74277675, CYAN_CHROMA, CYAN_HUE));
pub(crate) const ZENBURN_CYAN_PLUS_1: Lazy<Oklch> = Lazy::new(|| oklch(0.81345516, CYAN_CHROMA, CYAN_HUE));
